"""
Anthropic Claude AI provider for standup generator.
"""

from anthropic import Anthropic

class AnthropicProvider:
    """Anthropic Claude AI provider for standup generation."""
    ...
    def generate_standup_speech(self, commits):
        """
        Generate a standup speech using Anthropic's Claude API.
